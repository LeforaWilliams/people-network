...
export default class OtherProfile extends React.Component {
  ...
  async componentDidMount() {
    const res = await axios.get(`/get-user/${this.props.match.params.userId}`);
  ...
  render() {
    if (!this.state.imageUrl) {
      this.state.imageUrl = "http://www.psdgraphics.com/file/dark-gradient.jpg";
    }
    ...
    return (
      <div className="other-profile-wrap">
        ...
        <div className="bio-section">
          ...
          <Link to={`/private-chat/${this.props.match.params.userId}`}>
            <img className="plane" src="/images/paper-plane.svg" />
          </Link>
        </div>
